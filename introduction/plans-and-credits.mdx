---
title: "native.builder plans and credits"
sidebarTitle: "Plans and credits"
description: "Compare Free, Builder, Pro, Business, and Scale plans — how AI credits work, what uses credits, and how to manage billing."
keywords: ["pricing", "credits", "plans", "subscription", "billing", "promo code", "redeem", "free plan", "ai software factory"]
"og:title": "native.builder plans and credits"
"og:description": "Compare Free, Builder, Pro, Business, and Scale plans — how AI credits work, what uses credits, and how to manage billing."
---
...
<Steps>
  <Step title="Open Plans and Credits">
    ...
    <Frame>
      <img src="/images/promo-code/01-plans-and-credits-menu.png" alt="Home screen with the Plans and Credits menu item highlighted" />
    </Frame>
  </Step>
  <Step title="Click Change plan">
    ...
    <Frame>
      <img src="/images/promo-code/02-billing-change-plan.png" alt="Billing panel showing the Free plan and Change plan button" />
    </Frame>
  </Step>
  <Step title="Open the promo code field">
    ...
    <Frame>
      <img src="/images/promo-code/03-choose-a-plan-modal.png" alt="Choose a plan modal with Have a promo code link at the bottom" />
    </Frame>
  </Step>
  <Step title="Enter the code and Apply">
    ...
    <Frame>
      <img src="/images/promo-code/04-apply-promo-code.png" alt="Promo code entered in the Choose a plan modal with Apply button" />
    </Frame>
  </Step>
</Steps>
