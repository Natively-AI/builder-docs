...
<AccordionGroup>
  <Accordion title="What is Natively?">
    Natively is a software factory. Specialized AI agents — like roles on a dev team — plan, build, and ship web applications for you. Instead of hiring developers or paying an agency, you describe what you need and agents produce real, publishable software in a fraction of the time and cost.
  </Accordion>

  <Accordion title="Do I need to know how to code?">
    No. Natively is designed for both developers and non-developers. Describe what you want in plain language and the AI builds it for you. Developers can also inspect and edit the generated code directly.
  </Accordion>

  <Accordion title="What kind of apps can I build?">
    Natively builds Vite-based React web applications. This covers landing pages, dashboards, internal tools, SaaS frontends, and most standard web apps. Native mobile apps and backend-only services are outside the current scope.
  </Accordion>

  <Accordion title="How do I create a new project?">
    From the dashboard, type a description in the prompt box and submit. Natively creates a project and starts building. You can also open an existing project from your project list.
  </Accordion>
</AccordionGroup>
