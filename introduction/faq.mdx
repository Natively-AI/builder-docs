...
<AccordionGroup>
  ...
  <Accordion title="What kind of apps can I build?">
    Builder produces Vite-based React web applications. This covers landing pages, dashboards, internal tools, SaaS frontends, and most standard web apps. Native mobile apps and backend-only services are outside the current scope.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="How do I get help?">
    Join our [Discord community](https://discord.gg/AqxSSUaHfX) for the fastest responses — questions, tips, and updates from the team and other builders.

    You can also use the in-app **Help** button to report bugs, ask questions, or request features, or email [support@nativelyai.com](mailto:support@nativelyai.com). See [Support](/support) for details.
  </Accordion>
