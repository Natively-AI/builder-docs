---
title: Changelog
description: What's new in Native.Builder — release notes covering features, improvements, and fixes that affect how you build, collaborate, and ship.
---
...
- **Project design system** — Builder now generates a project design system (palette, typography, layout) at the start of a project and keeps UI consistent across pages. Steer it with style preferences in your initial brief, or edit `design-system/MASTER.md` from the Documents tab to influence future generations. See [Design system](/features/prompting#design-system).
