...
- **Fireworks AI BYOK** — Fireworks AI is now supported as a BYOK provider. Connect a Fireworks key in **Settings → Integrations** to unlock a Fireworks AI section in the model picker with Llama 3.1 405B, Llama 3.3 70B, Kimi 2.6, DeepSeek R1, DeepSeek V3, and Qwen3 235B. See [BYOK providers](/features/byok-providers) for details.
