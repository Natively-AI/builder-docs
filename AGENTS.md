...
| Term | Usage |
|------|--------|
| **native.builder** | Full product name — always lowercase (`native.builder`), never `Native.Builder`. Short form: **Builder**. Never use "Natively" for the product. |
...
- First mention on a page: **native.builder** (always lowercase). Subsequent mentions in the same section: **Builder**
