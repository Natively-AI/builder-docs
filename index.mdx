---
title: "Native.Builder documentation"
sidebarTitle: "Home"
description: "Official Native.Builder docs: build and ship web apps with AI agents — plans, credits, publish, Supabase, GitHub Sync, and more."
keywords: ["native.builder", "ai software factory", "ai app builder", "documentation", "natively"]
"og:title": "Native.Builder documentation"
"og:description": "Official Native.Builder docs: build and ship web apps with AI agents — plans, credits, publish, Supabase, GitHub Sync, and more."
mode: frame
---
