---
title: "AI software factory docs"
description: "Native.Builder is an AI software factory — a model-agnostic execution stack where agents build, ship, and iterate owned apps for teams, enterprises, and agencies."
mode: frame
---
