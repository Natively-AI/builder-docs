...
description: "Connect your own OpenRouter, AI/ML API, Fireworks AI, or Featherless AI key to unlock extra chat models in Native.Builder without using workspace credits."
---
