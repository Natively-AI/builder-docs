...
description: "Deploy a Native.Builder project to a live *.nativelyai.app URL, share it, unpublish, and manage stale deployments."
keywords: ["publish", "deploy", "live url", "nativelyai.app", "hosting"]
"og:title": "Publish your app on Native.Builder"
"og:description": "Deploy a Native.Builder project to a live *.nativelyai.app URL, share it, unpublish, and manage stale deployments."
---

**Publish** in **Native.Builder** deploys your project to a live URL on the Builder platform. Anyone with the link can visit your app — no local preview required.
