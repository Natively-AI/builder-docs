...
Publishing deploys your project to a live URL on the Natively platform. Anyone with the link can visit your app — no local preview required.

## What happens when you publish

1. Natively builds your project for production
...
<Steps>
  ...
  <Step title="Click Publish">
    Natively runs the production build and deploys your app. You'll see build output in the terminal panel.
  </Step>
