---
title: "Custom domains for native.builder apps"
sidebarTitle: "Custom domains"
description: "Connect your own domain to a published native.builder app, verify DNS, set a primary domain, and remove platform branding."
keywords: ["custom domain", "dns", "cname", "white label", "publish", "ai software factory"]
"og:title": "Custom domains for native.builder apps"
"og:description": "Connect your own domain to a published native.builder app, verify DNS, set a primary domain, and remove platform branding."
---

Custom domains let you serve your published app from your own URL (e.g., `app.yourcompany.com`) instead of the default `*.nativelyai.app` subdomain. For teams building **custom AI business software**, a branded domain signals that you **own the software** — not just rent space on a vendor subdomain.
