...
keywords: ["custom domain", "dns", "cname", "white label", "publish"]
...
**Custom domains** in **Native.Builder** let you serve your published app from your own URL (e.g., `app.yourcompany.com`) instead of the default `*.nativelyai.app` subdomain.
