---
title: "native.builder integrations"
sidebarTitle: "Integrations"
description: "Connect GitHub, Supabase, BYOK model providers, Google Drive, and Dropbox from Settings → Integrations in native.builder."
keywords: ["integrations", "github", "supabase", "byok", "google drive", "dropbox", "settings"]
"og:title": "native.builder integrations"
"og:description": "Connect GitHub, Supabase, BYOK model providers, Google Drive, and Dropbox from Settings → Integrations in native.builder."
---

Integrations connect <span class="brand-name">native.builder</span> to the tools your team already uses. Most connections are set up once per **workspace** under **Settings → Integrations**, then available to projects in that workspace.
...
Speechmatics isn’t a workspace Integrations card — you build Speechmatics features **in chat** with the Builder agent (your own API key, secured via Supabase). See [Build with Speechmatics](/features/speechmatics).
